...
<article class="featured-testimonial-card group">
  <div class="p-8 lg:p-12 {{ $cardBgClasses }} rounded-2xl min-h-full flex flex-col">
    {{-- Logo --}}
    @if($companyLogo)
      ...
      @if($quote)
        <div>
          ...
          <x-heading 
            :as="HeadingTag::H3" 
            :size="HeadingSize::H3" 
            class="text-primary-dark indent-[-0.45em] pl-[0.45em] text-center">
            <strong>
              "{{ $quote }}"
            </strong>
          </x-heading>
    ...
    <div class="flex justify-between mt-8 pt-6 border-t border-primary-dark">
