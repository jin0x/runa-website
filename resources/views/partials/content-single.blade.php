        ...
        <div class="sidebar">
          ...
          <div>
            ...
            <div class="flex gap-3">
              @if ( $github_url )
                <a href="<?php echo esc_url($github_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
              ...
              @if ( $twitter_url )
                <a href="<?php echo esc_url($twitter_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
              ...
              @if ( $linkedin_url )
                <a href="<?php echo esc_url($linkedin_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
                  <svg class="h-6 w-6" width="25" height="24" viewBox="0 0 25 24" fill="none">
              ...
              @if ( $facebook_url )
                <a href="<?php echo esc_url($facebook_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
              ...
              @if ( $instagram_url )
                <a href="<?php echo esc_url($instagram_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
                  <svg class="h-6 w-6" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              @if ( $x_url )
                <a href="<?php echo esc_url($x_url); ?>" class="flex items-center gap-2 hover:text-primary-green-neon transition-colors">
